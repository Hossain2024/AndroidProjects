package edu.tacoma.uw.unitconverter
...
import edu.tacoma.uw.unitconverter.ui.theme.UnitConverterTheme
...
fun UnitConverter() {
    ...
    fun convertUnits(){
        ...
        val result = (inputValueDouble * conversionFactor.value / oConversionFactor.value * 100)
            .roundToInt() / 100.0
        ...
        Row {
            ...
            Box{
                ...
                DropdownMenu(expanded = iExpanded , onDismissRequest = {iExpanded = false}) {
                    DropdownMenuItem(text = {Text("Centemetrs")},
                        onClick = {
                            iExpanded = false
